...
class ItemsStatus extends StatefulWidget {

  final String type;
  final String userId;
  const ItemsStatus({super.key, required this.userId, required this.type});

  @override
  State<ItemsStatus> createState() => _UpdateAdminState();
}

class _UpdateAdminState extends State<ItemsStatus> {
  late String userId;
  late String type;
  List<dynamic> users = [];
